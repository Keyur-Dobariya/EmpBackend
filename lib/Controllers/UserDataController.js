...
const { handleError, setDefaultUserData, findEmailAddress, findMobileNumber, hashPassword } = require("../utils/utils");
...
const getAllUsers = async (req, res) => {
    try {
        ...
        return res.status(200).json({ success: true, message: "Data fetched successfully", data: users });
    } catch (err) {
        return handleError(res, 'Internal Server Error');
    }
}
